...
const routes = [
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_login_login-routing_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./login/login-routing.module */ 5393)).then((m) => m.LoginRoutingModule)
    },
    {
        path: 'home',
